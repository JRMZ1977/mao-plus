...
| 016 | Saneamiento del reporte morfométrico (PDF/HTML) | 🟡 En curso: #1–#9 impl. #10–#11 pendientes | `analysis-core.js?v=20260912c` | #1 px→mm · #2 excentricidad · #3 regularidad · #4 hull · #5 detección/confianza · #6 semántico · #7 dif.área · #8 feret · #9 variación perímetro. **Enforcement: `test_coherencia_entrega.py`** 5/5. #10 ejes reales N/A en 2D · #11 distancia asimetría — pendientes |
