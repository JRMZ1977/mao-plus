...
| 015 | Plan de mejoras: superar brechas + optimizar matemáticas | 🟡 F1+B1 completados · F2(B2-B3,D1,D3)-F4 pendientes | `validation_stats.py`, `standardization.py`, `optical_calibration.py`, 4 test-suites (430 tests) | **F1 ✅** A1 exactitud Bland-Altman (MAE<5%) · A2 ICC(2,1) (≥0.90) · C3 CV+bootstrap. **B1 ✅** `optical_calibration.py` — perfil lente Zhang/plumb sustituye tabla FOV ±30%; Brown-Conrady con reconciliación convención k₁ (OpenCV r_n=r_px/fx); 3 endpoints API; 19 tests. Suite: 411/4. **Pendiente B2** relieve/paralaje · **B3** propagación incertidumbre · **D1** Klingenberg · **D3** armónicos EFA. |
