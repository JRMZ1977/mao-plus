...
| 016 | Saneamiento del reporte morfométrico (PDF/HTML) | 🟡 En curso: #1–#10 impl. #11 pendiente | `analysis-core.js?v=20260912d` | #1–#10 impl. **Enforcement: `test_coherencia_entrega.py`** 5/5. #11 distancia asimetría — pendiente |
