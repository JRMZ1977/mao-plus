...
| 015 | Plan de mejoras: superar brechas + optimizar matemáticas | 🟡 F1 completada (A1+A2+C3) · F2-F4 pendientes | `validation_stats.py`, `standardization.py`, 3 test-suites (52 tests) | **F1 ✅** A1 exactitud Bland-Altman (MAE<5% en área/perímetro/circularidad) · A2 ICC(2,1) (ICC≥0.90 área) · C3 CV+bootstrap estandarización → protocolo en `docs/VALIDACION-EXACTITUD.md`. Suite: 392/4. **F2** B1-B3 óptica/escala · D1 Klingenberg · D3 armónicos. **F3** C1/C2 morfoespacio · D2 pose 3D. **F4** E1 landmarks. |
