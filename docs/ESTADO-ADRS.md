...
| 011 | Taxonomía canónica de categorías | 🟡 F0-F1 + cobertura F2/F3 · **cableado real hecho por ADR-017** | — | El manifiesto `js/modules/category-manifest.js` existía desde F1 pero **no lo importaba ningún renderer** (código muerto). ADR-017 lo convierte en fuente única de orden/índice y lo cablea a las 5 superficies, cerrando F4/F5 |
