...
(function () {
  ...
  function buildHeader(container) {
    ...
    if (!hdr) {
      ...
      /* P4 — chip «listo para exportar». Tercer `.laar-chip` de la cabecera: como
         los de P/H y forma, el updater lo localiza por un selector acotado (su
         clase propia), nunca por `.laar-chip` a secas. */
